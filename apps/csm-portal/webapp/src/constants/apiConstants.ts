...
export const ApiQueryKeys = {
  ...
  SERVICE_REQUESTS_SEARCH_FOR_SELECT: "service-requests-search-for-select",
  ...
  CSM_CASE_ESCALATIONS: "csm-case-escalations",
  ...
  CSM_SEARCH: "csm-search",
  CSM_NOTIFICATIONS: "csm-notifications",
  CSM_ADMIN_USERS: "csm-admin-users",
  CSM_ADMIN_USER_DETAIL: "csm-admin-user-detail",
  CSM_ADMIN_ROLES: "csm-admin-roles",
